...
const idealFor = [
  "Emprendedores y freelancers digitales",
  "Dueños de negocios online",
  "Personas que ya venden un servicio o producto",
  "Quienes pueden grabarse aunque no sean expertos",
];

const notFor = [
  "Quien busca hacerse viral rápido",
  "Quien no quiere mostrarse en cámara",
  "Quien no tiene una oferta clara",
  "Quien espera resultados mágicos sin constancia",
];

const ReelsTargetSection = () => {
  return (
...
export default ReelsTargetSection;
